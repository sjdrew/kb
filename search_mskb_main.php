...
<title><? echo $AppDB->Settings->AppName ?> - Search Microsoft KB</title>
</head>
<?
...
function SearchNow()
{
window.location.replace("http://support.microsoft.com/search/default.aspx?catalog=LCID%3D1033&adv=&query=<? echo $Search ?>");
}
</script>
</html>
