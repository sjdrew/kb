...
// basedir is physical path to top level, UserFilesPath is appended to get complete path
// also UserFilesPath is used as url spec, ie "/file/KB012312" + filename
// If files are to be stored in d:/KB/files/KB012321 then basedir is d:/KB/

// basedir = d:/progs/Editor

// UserFilesPath:
// For Items that need url path to uploads: 
//			use APP_ROOT, ie /KB
//			append FILES_FOLDER, ie /files/KB1234
//			to get /KB/files/KB1234
//

// basedir:
// For Phyiscal location use APPL_PHYSICAL_PATH ie D:/PROGS/KBInstall
//			append UserFilesPath ie then = D:/PROGS/KBInstall/files/KB1234
// 

$fckphp_config['basedir']=APP_ROOT_DIR;
$_SERVER['DOCUMENT_ROOT']=dirname($fckphp_config['basedir']);
...
if ( isset( $_GET['ServerPath'] ) ) $fckphp_config['UserFilesPath'] = $_GET['ServerPath'] ;

/// Dyanmically create resource type below from passed 


/*------------------------------------------------------------------------------*/
/* Prefix added to image path before sending back to editor			*/
/*------------------------------------------------------------------------------*/
//$fckphp_config['urlprefix']=$fckphp_config['prot'].$_SERVER['SERVER_NAME']."/".APP_NAME;
$fckphp_config['urlprefix']="/".APP_NAME;
/*==============================================================================*/
...
$fckphp_config['ResourceAreas']['File'] =array(
	...
	'AllowedExtensions'	=>	array("txt","mht","mhtml","zip","doc","xls","pdf","rtf","csv","jpg","gif","jpeg","png","avi","mpg","mpeg","swf","fla"),
...
$fckphp_config['DebugOutput']="d:/progs/Editor/debug.txt";
