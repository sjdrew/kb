...
$sServerDir = APP_ROOT_DIR . $Config["UserFilesPath"] ; //sjd, relies on /config.php
@mkdir($sServerDir); //sjd

//SendResults( '1', '', '', ",$sServerDir, $sFileName" ) ;
...
while ( true )
{
	...
	else
	{
		...
		$sFileUrl = "/" . APP_NAME . $Config["UserFilesPath"] . $sFileName ;
