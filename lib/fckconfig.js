...
FCKConfig.AllowUploads = true; //sjd
...
FCKConfig.LinkBrowserURL = FCKConfig.BasePath + 'filemanager/browser/custom/browser.html?Connector=connectors/php/connector.php' ;
...
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/custom/browser.html?Type=File&Connector=connectors/php/connector.php' ;
FCKConfig.ImageBrowserWindowWidth  = screen.width * 0.7 ;	// 70% ;
FCKConfig.ImageBrowserWindowHeight = screen.height * 0.6 ;	// 70% ;
...
FCKConfig.FlashBrowserURL = FCKConfig.BasePath + 'filemanager/browser/custom/browser.html?Type=File&Connector=connectors/php/connector.php' ;
FCKConfig.FlashBrowserWindowWidth  = screen.width * 0.7 ;	//70% ;
FCKConfig.FlashBrowserWindowHeight = screen.height * 0.6 ;	//70% ;
...
// sjd Custom images in new folder
FCKConfig.SmileyPath	= FCKConfig.BasePath + 'images/smiley/custom/' ;

FCKConfig.SmileyImages	= ['regular_smile.gif','sad_smile.gif','accept.gif','arrow_out.gif','attach.gif','cross.gif','envelope.gif','error.gif','flag_green.gif','flag_red.gif','group.gif','help.gif','lightbulb2.gif','lightbulb.gif','lightning.gif','lock.gif','note.gif','page_excel.gif','page_white_word.gif','star.gif','thumbs_down.gif','thumbs_up.gif','tick.gif','user_comment.gif','user_suit.gif','whatchutalkingabout_smile.gif','world_go.gif','world_link.gif','wrench_orange.gif','zoom.gif'] ;
