          ...
          <tr valign="middle">
            <td width="180" valign="top" align="left" background="images/vert_bar.gif"> <img src="images/spacer.gif" width="180" height="1" border=0>
              <table width="87%" border="0" cellpadding="4" cellspacing="0">
                <tr>
                  <td align="center" width="36%" ><img src="images/reports.jpg" width="55" height="57"></td>
                  <td width="64%" align="center" valign="middle" class="hdr1">Reports</td>
                </tr>
                <tr>
            ...
            <td style="padding-left:20px;" colspan="2" valign="top"><p>&nbsp;</p>
              <ul>
